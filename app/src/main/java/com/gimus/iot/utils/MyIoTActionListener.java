...
import com.gimus.iot.iot.IoTActionListener;
...
public class MyIoTActionListener implements IoTActionListener {
    ...
    private void handleConnectSuccess() {
        ...
        //if (runningActivity != null && runningActivity.equals(ConnectFragment.class.getName())) {
