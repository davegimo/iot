...
public class Constants {
    ...
    public final static String APP_ID = "com.gimus.iot";
    ...
    // IoT properties
    //FINAL VALUES SO I DONT NEED TO DO AUTHENTICATION EVERYTIME
    public final static String ORGANIZATION = "au1kre";
    public final static String DEVICE_ID = "123456";
    public final static String AUTH_TOKEN = "secret123";
